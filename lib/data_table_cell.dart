...
import 'package:trial/checkbox_client.dart';
        ...
        Container(
          ...
          child: Row(
            children: [
              ...
              if (widget.checkbox) ...[
                CheckboxCell(selected: widget.selectAll, 
          ...
          child: Container(
            child: ListView.separated(
              ...
              itemBuilder: (context, rowIndex) {
                ...
                final bool selected = widget.selectedRows[rowIndex];
                return Container(
                  height: containerHeight,
                  decoration: BoxDecoration(
                  ...
                  child: Row(
                    children: [
                      const SizedBoxCell(width: 10),
                      if (widget.checkbox) ...[ 
                        CheckboxCell(selected: selected, onSelect: (value) {},selectall: false,index: rowIndex,),
                        const SizedBoxCell(width: 30),
                      ], // Placeholder for the image column
